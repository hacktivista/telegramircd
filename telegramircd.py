...
# This fork: https://github.com/prsai/telegramircd
# Upstream: https://github.com/MaskRay/telegramircd
# (C) Copyright 2016-2019 Fangrui Song
# (C) Copyright 2018 aconitumnapellus, alecdwm
...
class StatusChannel(Channel):
    ...
    def on_notice_or_privmsg(self, client, command, msg):
        ...
        if msg == 'help':
            ...
            chunk_size = 20
            self.respond(client, 'Dialogs:')
            self.respond(client, '  {:<10} {:<10} {:<10} {}  {}', 'Id', 'Unread', 'Mentions', 'Type', 'Name')
